...
import { Code2, Sun, Moon, Menu, X, Globe } from "lucide-react";
import { cn } from "@/lib/utils";
import { siteConfig, type NavKey } from "@/config/site";
import { MobileDrawer } from "@/components/layout/mobile-drawer";

const navToSectionMap: Record<NavKey, keyof typeof siteConfig.sections> = {
  about: "about",
...
const navKeys = siteConfig.nav.filter(
  (key) => siteConfig.sections[navToSectionMap[key]]
);
      ...
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            >
              <Code2 className="h-5 w-5 text-accent transition-transform group-hover:scale-110" />
            </button>
